...
$menu['config']['text'] = MAIN_ADMIN_NEWSONTWITTER_L1;
$menu['config']['link'] = "admin.php";
$menu['list']['text'] = MAIN_ADMIN_NEWSONTWITTER_L2;
$menu['list']['link'] = "admin_list.php";
$menu['install']['text'] = MAIN_ADMIN_NEWSONTWITTER_L3;
$menu['install']['link'] = "admin_install.php";

show_admin_menu(MAIN_ADMIN_NEWSONTWITTER_L0, $pageid, $menu);
